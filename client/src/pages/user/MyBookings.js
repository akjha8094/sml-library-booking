...
const MyBookings = () => {
  ...
  const canRequestRefund = (booking) => {
    // Debug logging
    console.log('Checking refund eligibility for booking:', booking.id);
    console.log('Booking status:', booking.status);
    console.log('Payment status:', booking.payment_status);
    console.log('Refund status:', booking.refund_status);
    
    // Can request refund if:
    // 1. Booking is active or completed
    // 2. Not already fully refunded
    // 3. Has a completed payment OR just check if booking has final_amount
    const isEligible = (
    ...
    console.log('Is eligible for refund:', isEligible);
    return isEligible;
  };
  ...
  const handleRefundSubmit = async (e) => {
    ...
    console.log('Form data:', refundForm);
    ...
    try {
      ...
      const response = await api.createRefundRequest(requestData);
              ...
              >
                ...
                <div style={{ width: '100%' }}>
                  <div style={{ display: 'flex', gap: '20px', alignItems: 'start', flexWrap: 'wrap' }}>
                    ...
                    {/* Actions */}
                    <div style={{ display: 'flex', gap: '10px', flexDirection: 'row', flexWrap: 'wrap', marginTop: '15px' }}>
                      <button
